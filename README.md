About django-removals-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-removals-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-removals-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-removals
# for installing globally
pixi global install django-removals
```
...
It is possible to list all of the versions of `django-removals` available on your platform:
...
```
pixi search django-removals --channel conda-forge
```
